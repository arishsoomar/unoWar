...
public class AITest {
    ...
    public static void main(String[] args) {
        ...
        AI testAI2 = new SmallestCardAI();

        System.out.println("Top card is: " + pile2.getTopCard());

        System.out.println("Hand is: ");
        System.out.println(hand2.get(0));
        System.out.println(hand2.get(1));
        System.out.println(hand2.get(2));
        System.out.println(hand2.get(3));
        System.out.println(hand2.get(4));

        Card choice2 = testAI2.getPlay(hand2, pile2);

        System.out.println("AI chose: " + choice2);
